        ...
        <div className="mx-auto max-w-5xl grid gap-12 lg:grid-cols-2">
          ...
          <div className="space-y-6">
            <div className="rounded-2xl border border-gray-200 bg-white p-6 shadow-sm space-y-5">
              ...
              <div className="flex items-start gap-4"><div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-lg" style={{ background: 'hsl(165 70% 36% / 0.1)' }}><Mail className="h-5 w-5" style={{ color: 'hsl(165 70% 36%)' }} /></div><div><p className="text-sm font-medium" style={{ color: 'hsl(210 30% 15%)' }}>E-Mail</p><a href="mailto:info@futureroom.de" className="text-sm hover:underline" style={{ color: 'hsl(165 70% 36%)' }}>info@futureroom.de</a></div></div>
              <div className="flex items-start gap-4"><div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-lg" style={{ background: 'hsl(165 70% 36% / 0.1)' }}><Phone className="h-5 w-5" style={{ color: 'hsl(165 70% 36%)' }} /></div><div><p className="text-sm font-medium" style={{ color: 'hsl(210 30% 15%)' }}>Telefon</p><p className="text-sm text-gray-500">089 66667788</p></div></div>
