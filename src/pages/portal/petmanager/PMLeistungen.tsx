 ...
 * CI-konform: PageShell, ModulePageHeader, RECORD_CARD tokens
 */
import { useState } from 'react';
import { Plus, Trash2, Edit2, Clock, Save } from 'lucide-react';
...
export default function PMLeistungen() {
  ...
  if (!provider) {
    return (
      <PageShell>
        <ModulePageHeader title="Leistungen" description="Deine Services und Verfügbarkeit" />
  ...
  return (
    <PageShell>
      ...
      {/* Services List — glass-card CI pattern */}
      <div className="glass-card rounded-xl p-5">
        <h2 className={RECORD_CARD.SECTION_TITLE}>Meine Services ({services.length})</h2>
        {services.length === 0 ? (
      ...
      {/* Availability — glass-card CI pattern */}
      <div className="glass-card rounded-xl p-5">
        <div className="flex items-center justify-between mb-3">
          <h2 className={RECORD_CARD.SECTION_TITLE}><Clock className="h-4 w-4 inline mr-1.5" />Verfügbarkeit</h2>
