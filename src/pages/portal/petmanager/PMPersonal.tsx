/**
 * PMPersonal — Mitarbeiter-Verwaltung (CI-konform)
 * Layout: Widget-Spalte links, Inline-Akte rechts
 * Tokens: glass-card, RECORD_CARD, ModulePageHeader, PageShell
 */
  ...
  return (
    <PageShell>
      ...
      <div className="flex flex-col md:flex-row gap-4">
            ...
            {staff.map(member => {
              ...
              return (
                <div
                  key={member.id}
                  className={cn(
                    'glass-card rounded-xl cursor-pointer transition-all hover:shadow-lg flex-shrink-0',
                    'w-36 md:w-full aspect-square overflow-hidden',
                    isSelected && 'ring-2 ring-primary shadow-lg',
                    !member.is_active && 'opacity-60',
                  )}
                  onClick={() => handleSelect(member)}
                >
                  <div className={cn('h-1.5 rounded-t-xl', member.is_active ? 'bg-primary' : 'bg-muted')} />
        ...
        {/* Right: Inline Akte — glass-card CI */}
        {showAkte && (
            ...
            <div className="glass-card rounded-xl p-5">
              ...
              <div className="space-y-4">
                ...
                <div className="space-y-3">
                  <h3 className={RECORD_CARD.SECTION_TITLE}>Basisdaten</h3>
                  <div>
                    <Label>Name *</Label>
                ...
                {/* Dienstleistungen */}
                <div>
                  <h3 className={RECORD_CARD.SECTION_TITLE}>Dienstleistungen</h3>
                ...
                {/* Arbeitszeiten */}
                <div>
                  <h3 className={RECORD_CARD.SECTION_TITLE}>Arbeitszeiten</h3>
                ...
                {selectedId && (
                  <div>
                    <div className="flex items-center justify-between">
                      <h3 className={RECORD_CARD.SECTION_TITLE}>Urlaub / Abwesenheiten</h3>
                      <Button
                        variant="ghost"
                        size="sm"
                    ...
                    {vacations.length > 0 && (
                      <div className="space-y-1 mb-2">
                        {vacations.map(v => (
                          <div key={v.id} className="flex items-center gap-2 text-xs bg-muted/40 rounded-lg px-2 py-1.5">
                    ...
                    {newVacation && (
                      <div className="flex flex-wrap items-end gap-2 bg-muted/30 rounded-lg p-2">
                        <div>
