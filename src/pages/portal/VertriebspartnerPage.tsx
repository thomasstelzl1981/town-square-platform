...
const VertriebspartnerPage = () => {
  ...
  const handleExportPDF = () => {
    toast.info('PDF-Export wird vorbereitet...', {
      description: 'Beratungsprotokoll wird erstellt.'
    });
  };
          ...
          <div className="grid gap-4 md:grid-cols-2">
            ...
            <Card>
              ...
              <CardContent className="space-y-3">
                <Button variant="outline" className="w-full justify-start" onClick={() => setActiveTab('katalog')}>
                  <BookOpen className="mr-2 h-4 w-4" />
                  Objektkatalog öffnen
                </Button>
                <Button variant="outline" className="w-full justify-start" onClick={() => setActiveTab('beratung')}>
