 ...
 * 
 * Routes (handled by ManifestRouter + internal routing):
 ...
 * - /portal/immobilien/neu → Create Property (redirect to portfolio with modal)
  ...
  return (
    <Suspense fallback={<LoadingFallback />}>
      <Routes>
        ...
        {/* CREATE: Direct redirect - no lazy loading to avoid delay */}
        <Route path="neu" element={<Navigate to="/portal/immobilien/portfolio?create=1" replace />} />
