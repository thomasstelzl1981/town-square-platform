...
export function EmailTab() {
  ...
  // No account connected - show connection UI
  if (!hasConnectedAccount) {
    return (
      <div className="space-y-6">
        {/* Email Module Structure Preview */}
        <div className="grid grid-cols-12 gap-4 opacity-50 pointer-events-none">
          {/* Left Sidebar - Folders */}
          <div className="col-span-2 border rounded-lg p-3 space-y-2 min-h-[400px]">
          ...
          {/* Middle - Email List */}
          <div className="col-span-4 border rounded-lg flex flex-col min-h-[400px]">
            <div className="p-3 border-b">
              <div className="flex items-center gap-2">
                <div className="relative flex-1">
                  <Search className="absolute left-3 top-1/2 -translate-y-1/2 h-4 w-4 text-muted-foreground" />
                  <Input placeholder="E-Mails durchsuchen..." className="pl-9" disabled />
                </div>
              </div>
            </div>
          ...
          {/* Right - Email Detail */}
          <div className="col-span-6 border rounded-lg flex flex-col min-h-[400px]">
        ...
        <Card className="absolute inset-x-6 top-1/2 -translate-y-1/2 max-w-2xl mx-auto shadow-xl">
  ...
  // Connected account - show email client
  return (
      ...
      <div className="col-span-4 border rounded-lg flex flex-col">
        ...
        <div className="flex-1 flex items-center justify-center p-8">
          <div className="text-center space-y-3">
            ...
            <p className="text-sm text-muted-foreground">
              Keine E-Mails im {folders.find(f => f.id === selectedFolder)?.name || 'Ordner'}
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="col-span-6 border rounded-lg flex flex-col">
        <div className="flex-1 flex items-center justify-center text-center p-8">
          <div className="space-y-3">
            ...
            <h3 className="font-semibold">Keine E-Mail ausgewählt</h3>
            <p className="text-sm text-muted-foreground">
              Wählen Sie eine E-Mail aus der Liste aus, um sie hier anzuzeigen.
            </p>
          </div>
        </div>
      </div>
