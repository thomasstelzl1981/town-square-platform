...
export const SOT_WEBSITE_MODULES: SotWebsiteModule[] = [
  ...
  },
  {
    ...
    description: 'Armstrong — unser KI-Assistent — schreibt E-Mails, erstellt Briefe, koordiniert Termine und priorisiert Aufgaben. Angetrieben von Google Gemini und OpenAI GPT-5. Inklusive WhatsApp-Integration und Web-Research.',
    ...
    features: ['KI-E-Mails (Armstrong)', 'KI-Briefe', 'Kalender & Termine', 'Aufgaben priorisieren', 'WhatsApp-Integration', 'Web-Research'],
    icon: 'Sparkles',
    category: 'client',
    highlight: true,
  },
