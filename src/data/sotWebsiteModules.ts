...
export const SOT_WEBSITE_MODULES: SotWebsiteModule[] = [
  ...
  },
  {
    ...
    painPoints: [
      'Website-Erstellung dauert Wochen und kostet tausende Euro',
      'Inhalte sind veraltet, weil Updates umständlich sind',
      'SEO und Mobile-Optimierung werden vergessen',
    ],
