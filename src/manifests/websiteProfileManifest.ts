...
export const WEBSITE_PROFILES: WebsiteProfile[] = [
  ...
  {
    profileId: 'lead_agency',
    moduleCode: 'MOD-10',
    displayName: 'Leadmanager',
    description: 'Marketing-Agenturen, Leadgeneratoren und Kampagnen-Manager',
    defaultTemplate: 'fresh',
    availableSections: [
      'hero', 'about', 'services', 'features', 'testimonials',
      'gallery', 'contact', 'footer', 'pricing', 'team',
    ],
    requiredSections: ['hero', 'services', 'contact', 'footer'],
    exampleIndustries: ['Marketing-Agentur', 'Leadgenerator', 'Performance-Marketing', 'Social Media Agentur'],
    bookingEnabled: true,
    shopEnabled: false,
    sampleContent: {
      hero: { headline: 'Leads die konvertieren', subline: 'Datengetriebenes Marketing für messbare Ergebnisse.' },
      services: { title: 'Unsere Leistungen', items: ['Lead-Generierung', 'Kampagnen-Management', 'Performance-Analyse'] },
    },
  },
  {
