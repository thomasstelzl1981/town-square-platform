...
export const LEDGER_EVENT_WHITELIST: ReadonlySet<string> = new Set([
  ...
  // ─── GP-PET: Pet Manager Lifecycle ─────────────────────────
  'pet.lead.captured',
  'pet.z1.profile.created',
  'pet.customer.created',
  'pet.customer.assigned',
  'pet.mod05.linked',
  'pet.booking.first_completed',

  // ─── GP-PET: Fail-States ──────────────────────────────────
  'pet.lead.capture.duplicate_detected',
  'pet.lead.capture.error',
  'pet.z1.profile.create.error',
  'pet.customer.assign.timeout',
  'pet.customer.assign.rejected',
  'pet.customer.assign.error',

  // ─── GP-COMMISSION: Systemgebühr Events ────────────────────
  'commission.agreement.accepted',
  'commission.agreement.rejected',
  ...
  'slc.inquiry.timeout',
  'slc.reserved',
  'slc.reserved.timeout',
  'slc.finance.submitted',
  'slc.finance.timeout',
  'slc.contract.drafted',
  'slc.contract.timeout',
  'slc.notary_schedule.timeout',
  'slc.notary.error',
  'slc.handover.timeout',
