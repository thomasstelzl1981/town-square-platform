...
export const armstrongActions: ArmstrongActionV2[] = [
  ...
  // ===========================================================================
  // MOD-02: KI OFFICE — RECHERCHE ACTIONS
  // ===========================================================================
  {
    action_code: 'ARM.MOD02.RESEARCH_FREE',
    ...
    ui_entrypoints: ['/portal/office/widgets'],
    audit_event_type: 'ARM_RESEARCH_FREE',
    status: 'active',
  },
  {
    action_code: 'ARM.MOD02.RESEARCH_PRO',
  ...
  {
    action_code: 'ARM.MOD02.IMPORT_CANDIDATES',
  ...
  {
    action_code: 'ARM.MOD02.DEDUPE_SUGGEST',
