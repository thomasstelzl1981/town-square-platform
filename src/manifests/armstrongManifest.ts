...
export const armstrongActions: ArmstrongActionV2[] = [
  ...
  // ===========================================================================
  // MOD-21: KI-BROWSER (10 Actions)
  // ===========================================================================

  {
    action_code: 'ARM.BROWSER.START_SESSION',
    title_de: 'Browser-Session starten',
    description_de: 'Startet eine neue KI-Browser Research-Session mit Policy-Profil und TTL',
    zones: ['Z2'],
    module: 'MOD-21',
    risk_level: 'medium',
    execution_mode: 'execute_with_confirmation',
    requires_consent_code: null,
    roles_allowed: [],
    data_scopes_read: ['ki_browser_policies'],
    data_scopes_write: ['ki_browser_sessions'],
    side_effects: ['credits_consumed'],
    version: '1.0.0',
    cost_model: 'metered',
    cost_unit: 'per_call' as CostUnit,
    cost_hint_cents: 25,
    api_contract: { type: 'edge_function' as const, endpoint: 'sot-ki-browser' },
    ui_entrypoints: ['/portal/ki-browser/session'],
    audit_event_type: 'ARM_BROWSER_START_SESSION',
    status: 'active' as ActionStatus,
  },
  {
    action_code: 'ARM.BROWSER.OPEN_URL',
    title_de: 'URL öffnen',
    description_de: 'Öffnet eine URL und extrahiert den Seiteninhalt als Text',
    zones: ['Z2'],
    module: 'MOD-21',
    risk_level: 'low',
    execution_mode: 'execute',
    requires_consent_code: null,
    roles_allowed: [],
    data_scopes_read: ['ki_browser_sessions', 'ki_browser_domain_rules'],
    data_scopes_write: ['ki_browser_steps'],
    side_effects: [],
    version: '1.0.0',
    cost_model: 'free',
    cost_unit: null,
    ...
    api_contract: { type: 'edge_function' as const, endpoint: 'sot-ki-browser' },
    ui_entrypoints: ['/portal/ki-browser/session'],
    audit_event_type: 'ARM_BROWSER_OPEN_URL',
    status: 'active' as ActionStatus,
  },
  {
    action_code: 'ARM.BROWSER.SEARCH',
    title_de: 'Web-Suche ausführen',
    description_de: 'Führt eine Web-Suche durch und liefert strukturierte Ergebnisse',
    zones: ['Z2'],
    module: 'MOD-21',
    risk_level: 'medium',
    execution_mode: 'execute_with_confirmation',
    requires_consent_code: null,
    roles_allowed: [],
    data_scopes_read: ['ki_browser_sessions'],
    data_scopes_write: ['ki_browser_steps'],
    ...
    api_contract: { type: 'edge_function' as const, endpoint: 'sot-ki-browser' },
    ui_entrypoints: ['/portal/ki-browser/session'],
    audit_event_type: 'ARM_BROWSER_SEARCH',
    status: 'active' as ActionStatus,
  },
  {
    action_code: 'ARM.BROWSER.CLICK',
    title_de: 'Element anklicken',
    description_de: 'Klickt ein Element auf der Seite (Phase 2: externer Browser-Dienst)',
    zones: ['Z2'],
    module: 'MOD-21',
    risk_level: 'medium',
    execution_mode: 'execute_with_confirmation',
    ...
    api_contract: { type: 'edge_function' as const, endpoint: 'sot-ki-browser' },
    ui_entrypoints: ['/portal/ki-browser/session'],
    audit_event_type: 'ARM_BROWSER_CLICK',
    status: 'planned' as ActionStatus,
  },
  {
    action_code: 'ARM.BROWSER.TYPE',
    title_de: 'Text eingeben',
    description_de: 'Gibt Text in ein Formularfeld ein (Hard Guardrails für Passwort/OTP-Felder)',
    zones: ['Z2'],
    module: 'MOD-21',
    risk_level: 'high',
    execution_mode: 'execute_with_confirmation',
    ...
    api_contract: { type: 'edge_function' as const, endpoint: 'sot-ki-browser' },
    ui_entrypoints: ['/portal/ki-browser/session'],
    audit_event_type: 'ARM_BROWSER_TYPE',
    status: 'planned' as ActionStatus,
  },
  {
    action_code: 'ARM.BROWSER.SCROLL',
    title_de: 'Seite scrollen',
    description_de: 'Scrollt die aktuelle Seite (Phase 2: externer Browser-Dienst)',
    zones: ['Z2'],
    module: 'MOD-21',
    risk_level: 'low',
    execution_mode: 'execute',
    ...
    api_contract: { type: 'edge_function' as const, endpoint: 'sot-ki-browser' },
    ui_entrypoints: ['/portal/ki-browser/session'],
    audit_event_type: 'ARM_BROWSER_SCROLL',
    status: 'planned' as ActionStatus,
  },
  {
    action_code: 'ARM.BROWSER.EXTRACT',
    title_de: 'Inhalte extrahieren',
    description_de: 'Extrahiert Text, Links oder Tabellen aus der aktuellen Seite',
    zones: ['Z2'],
    module: 'MOD-21',
    risk_level: 'medium',
    execution_mode: 'execute_with_confirmation',
    requires_consent_code: null,
    roles_allowed: [],
    data_scopes_read: ['ki_browser_sessions', 'ki_browser_steps'],
    data_scopes_write: ['ki_browser_steps', 'ki_browser_artifacts'],
    side_effects: ['credits_consumed'],
    version: '1.0.0',
    cost_model: 'metered',
    cost_unit: 'per_call' as CostUnit,
    cost_hint_cents: 25,
    api_contract: { type: 'edge_function' as const, endpoint: 'sot-ki-browser' },
    ui_entrypoints: ['/portal/ki-browser/session', '/portal/ki-browser/quellen'],
    audit_event_type: 'ARM_BROWSER_EXTRACT',
    status: 'active' as ActionStatus,
  },
  {
    action_code: 'ARM.BROWSER.SCREENSHOT',
    title_de: 'Screenshot erstellen',
    description_de: 'Erstellt einen Screenshot der aktuellen Seite (Phase 2: externer Browser-Dienst)',
    zones: ['Z2'],
    module: 'MOD-21',
    risk_level: 'low',
    execution_mode: 'execute',
    ...
    api_contract: { type: 'edge_function' as const, endpoint: 'sot-ki-browser' },
    ui_entrypoints: ['/portal/ki-browser/session'],
    audit_event_type: 'ARM_BROWSER_SCREENSHOT',
    status: 'planned' as ActionStatus,
  },
  {
    action_code: 'ARM.BROWSER.SUMMARIZE',
    title_de: 'Ergebnisse zusammenfassen',
    description_de: 'Erstellt einen KI-generierten Bericht mit Quellen und Zitaten',
    zones: ['Z2'],
    module: 'MOD-21',
    risk_level: 'medium',
    execution_mode: 'execute_with_confirmation',
    requires_consent_code: null,
    roles_allowed: [],
    data_scopes_read: ['ki_browser_sessions', 'ki_browser_artifacts'],
    data_scopes_write: ['ki_browser_steps', 'ki_browser_artifacts'],
    side_effects: ['credits_consumed'],
    version: '1.0.0',
    cost_model: 'metered',
    ...
    api_contract: { type: 'edge_function' as const, endpoint: 'sot-ki-browser' },
    ui_entrypoints: ['/portal/ki-browser/session', '/portal/ki-browser/quellen'],
    audit_event_type: 'ARM_BROWSER_SUMMARIZE',
    status: 'active' as ActionStatus,
  },
  {
    action_code: 'ARM.BROWSER.END_SESSION',
    title_de: 'Session beenden',
    description_de: 'Beendet die aktive Browser-Session und generiert optional einen Abschlussbericht',
    zones: ['Z2'],
    module: 'MOD-21',
    risk_level: 'low',
    execution_mode: 'execute',
    ...
    api_contract: { type: 'edge_function' as const, endpoint: 'sot-ki-browser' },
    ui_entrypoints: ['/portal/ki-browser/session'],
    audit_event_type: 'ARM_BROWSER_END_SESSION',
    status: 'active' as ActionStatus,
  },
