...
export const TOP_30_MVP_ACTION_CODES = [
  ...
  'ARM.MOD13.VALIDATE_DATA',
  'ARM.MOD13.PHASE_CHANGE',
  'ARM.MOD13.PUBLISH_LISTINGS',
  'ARM.MOD13.PROJECT_SUMMARY',
...
export const armstrongActions: ArmstrongActionV2[] = [
  ...
  // ===========================================================================
  // ZONE 3 — LEAD CAPTURE ACTIONS (Armstrong Zone 3 Sales Assistant)
  // ===========================================================================
  {
    action_code: 'ARM.Z3.KAUFY.CAPTURE_LEAD',
    title_de: 'Kontakt und Lead erfassen',
    description_de: 'Erfasst Name und E-Mail als Lead im Kaufy-Kontext',
    zones: ['Z3'] as ArmstrongZone[],
    module: null,
    risk_level: 'low' as RiskLevel,
    execution_mode: 'execute' as ExecutionMode,
    ...
    side_effects: ['creates_lead_record'],
    version: '1.0.0',
    cost_model: 'free' as CostModel,
    cost_unit: null,
    cost_hint_cents: null,
    ...
    ui_entrypoints: ['/website/kaufy', '/kaufy'],
    audit_event_type: 'ARM_Z3_KAUFY_CAPTURE_LEAD',
    status: 'active' as ActionStatus,
  },
  {
    action_code: 'ARM.Z3.KAUFY.REQUEST_EXPOSE',
    title_de: 'Exposé anfordern',
    description_de: 'Fordert ein Exposé für ein Inserat an und erfasst den Lead',
    zones: ['Z3'] as ArmstrongZone[],
    module: null,
    risk_level: 'low' as RiskLevel,
    execution_mode: 'execute' as ExecutionMode,
    ...
    api_contract: { type: 'edge_function' as const, endpoint: 'sot-armstrong-advisor' },
    ui_entrypoints: ['/website/kaufy', '/kaufy'],
    audit_event_type: 'ARM_Z3_KAUFY_REQUEST_EXPOSE',
    status: 'active' as ActionStatus,
  },
  {
    action_code: 'ARM.Z3.FR.CAPTURE_LEAD',
    title_de: 'Finanzierungs-Lead erfassen',
    description_de: 'Erfasst qualifizierte Finanzierungsdaten als Lead',
    zones: ['Z3'] as ArmstrongZone[],
    module: null,
    risk_level: 'low' as RiskLevel,
    ...
    api_contract: { type: 'edge_function' as const, endpoint: 'sot-armstrong-advisor' },
    ui_entrypoints: ['/website/futureroom', '/futureroom'],
    audit_event_type: 'ARM_Z3_FR_CAPTURE_LEAD',
    status: 'active' as ActionStatus,
  },
  {
    action_code: 'ARM.Z3.FR.QUICK_CHECK',
    title_de: 'Schnell-Einschätzung Finanzierung',
    description_de: 'Berechnet eine grobe Finanzierbarkeit anhand von Einkommen und Eigenkapital',
    zones: ['Z3'] as ArmstrongZone[],
    module: null,
    risk_level: 'low' as RiskLevel,
    execution_mode: 'readonly' as ExecutionMode,
    ...
    api_contract: { type: 'internal' as const, endpoint: null },
    ui_entrypoints: ['/website/futureroom', '/futureroom'],
    audit_event_type: 'ARM_Z3_FR_QUICK_CHECK',
    status: 'active' as ActionStatus,
  },
  {
    action_code: 'ARM.Z3.SOT.BOOK_DEMO',
    title_de: 'Demo-Termin buchen',
    description_de: 'Bucht einen Demo-Termin für System of a Town und erfasst den Lead',
    zones: ['Z3'] as ArmstrongZone[],
    module: null,
    risk_level: 'low' as RiskLevel,
    execution_mode: 'execute_with_confirmation' as ExecutionMode,
    ...
    api_contract: { type: 'edge_function' as const, endpoint: 'sot-armstrong-advisor' },
    ui_entrypoints: ['/website/sot', '/sot'],
    audit_event_type: 'ARM_Z3_SOT_BOOK_DEMO',
    status: 'active' as ActionStatus,
  },
  {
    action_code: 'ARM.Z3.SOT.RECOMMEND_MODULES',
    title_de: 'Modul-Empfehlung',
    description_de: 'Empfiehlt passende SoT-Module basierend auf Beruf und Unternehmensgröße',
    zones: ['Z3'] as ArmstrongZone[],
    module: null,
    risk_level: 'low' as RiskLevel,
    execution_mode: 'readonly' as ExecutionMode,
    ...
    api_contract: { type: 'internal' as const, endpoint: null },
    ui_entrypoints: ['/website/sot', '/sot'],
    audit_event_type: 'ARM_Z3_SOT_RECOMMEND_MODULES',
    status: 'active' as ActionStatus,
  },
  ...
  // ===========================================================================
  {
    ...
    cost_hint_cents: null,
    api_contract: { type: 'internal' as const, endpoint: null },
    ui_entrypoints: ['/portal/provisionen'],
  ...
  },
  {
    ...
    description_de: 'Erstellt eine Finanzierungsanfrage und Antragstellerprofil aus hochgeladenen Dokumenten (Selbstauskunft, Gehaltsnachweis)',
    zones: ['Z2'] as ArmstrongZone[],
    module: 'MOD-11',
    risk_level: 'medium' as RiskLevel,
    execution_mode: 'execute_with_confirmation' as ExecutionMode,
    ...
    api_contract: { type: 'edge_function' as const, endpoint: 'sot-armstrong-advisor' },
    ui_entrypoints: ['/portal/finanzierungsmanager'],
    audit_event_type: 'ARM_MOD11_MAGIC_INTAKE_CASE',
    status: 'active' as ActionStatus,
  },
  {
    action_code: 'ARM.MOD04.MAGIC_INTAKE_PROPERTY',
    title_de: 'Immobilie aus Dokument anlegen',
    description_de: 'Erstellt eine Immobilie mit Einheiten aus hochgeladenen Dokumenten (Kaufvertrag, Exposé, PDF)',
    zones: ['Z2'] as ArmstrongZone[],
    module: 'MOD-04',
    risk_level: 'medium' as RiskLevel,
    execution_mode: 'execute_with_confirmation' as ExecutionMode,
    ...
    roles_allowed: [],
    data_scopes_read: ['storage_nodes'],
    data_scopes_write: ['properties', 'units', 'storage_nodes', 'inbox_sort_containers'],
    side_effects: ['credits_consumed', 'creates_storage_tree'],
    version: '1.0.0',
    cost_model: 'metered' as CostModel,
    cost_unit: 'per_call' as CostUnit,
    ...
    api_contract: { type: 'edge_function' as const, endpoint: 'sot-armstrong-advisor' },
    ui_entrypoints: ['/portal/immobilien'],
    audit_event_type: 'ARM_MOD04_MAGIC_INTAKE_PROPERTY',
    status: 'active' as ActionStatus,
  },
  {
    action_code: 'ARM.MOD18.MAGIC_INTAKE_FINANCE',
    title_de: 'Finanzdaten aus Dokument erfassen',
    description_de: 'Erfasst Versicherungen, Abonnements oder Bankdaten aus hochgeladenen Dokumenten (Kontoauszug, Versicherungsschein)',
    zones: ['Z2'] as ArmstrongZone[],
    module: 'MOD-18',
    risk_level: 'medium' as RiskLevel,
    execution_mode: 'execute_with_confirmation' as ExecutionMode,
    ...
    cost_hint_cents: 50,
    api_contract: { type: 'edge_function' as const, endpoint: 'sot-armstrong-advisor' },
    ui_entrypoints: ['/portal/finanzanalyse'],
    audit_event_type: 'ARM_MOD18_MAGIC_INTAKE_FINANCE',
    status: 'active' as ActionStatus,
  },
  {
  ...
  // ===========================================================================
  // MOD-13: PROJEKTE — Intake-Begleitung (Kategorie A)
  // ===========================================================================
  {
    action_code: 'ARM.MOD13.EXPLAIN_UPLOAD_FORMATS',
    title_de: 'Upload-Formate erklären',
    description_de: 'Erklärt welche Dateiformate für den Magic Intake akzeptiert werden',
    zones: ['Z2'] as ArmstrongZone[],
    module: 'MOD-13',
    risk_level: 'low' as RiskLevel,
    execution_mode: 'readonly' as ExecutionMode,
    ...
    api_contract: { type: 'internal' as const, endpoint: null },
    ui_entrypoints: ['/portal/projekte'],
    audit_event_type: 'ARM_MOD13_EXPLAIN_UPLOAD',
    status: 'active' as ActionStatus,
  },
  {
    action_code: 'ARM.MOD13.SHOW_EXAMPLE',
    title_de: 'Beispiel-Exposé zeigen',
    description_de: 'Zeigt ein Beispiel-Exposé und erklärt den idealen Dokumentaufbau',
    zones: ['Z2'] as ArmstrongZone[],
    module: 'MOD-13',
    risk_level: 'low' as RiskLevel,
    execution_mode: 'readonly' as ExecutionMode,
    ...
    api_contract: { type: 'internal' as const, endpoint: null },
    ui_entrypoints: ['/portal/projekte'],
    audit_event_type: 'ARM_MOD13_SHOW_EXAMPLE',
    status: 'active' as ActionStatus,
  },
  {
    action_code: 'ARM.MOD13.EXPLAIN_ANALYSIS_TIME',
    title_de: 'Analysedauer erklären',
    description_de: 'Erklärt wie lange die KI-Analyse eines Exposés oder einer Preisliste dauert',
    zones: ['Z2'] as ArmstrongZone[],
    module: 'MOD-13',
    risk_level: 'low' as RiskLevel,
    execution_mode: 'readonly' as ExecutionMode,
    ...
    api_contract: { type: 'internal' as const, endpoint: null },
    ui_entrypoints: ['/portal/projekte'],
    audit_event_type: 'ARM_MOD13_EXPLAIN_TIME',
    status: 'active' as ActionStatus,
  },
  {
    action_code: 'ARM.MOD13.REVIEW_UNITS',
    title_de: 'Einheiten prüfen',
    description_de: 'Gibt Tipps zur Prüfung der erkannten Einheiten nach der KI-Analyse',
    zones: ['Z2'] as ArmstrongZone[],
    module: 'MOD-13',
    risk_level: 'low' as RiskLevel,
    execution_mode: 'readonly' as ExecutionMode,
    ...
    api_contract: { type: 'internal' as const, endpoint: null },
    ui_entrypoints: ['/portal/projekte'],
    audit_event_type: 'ARM_MOD13_REVIEW_UNITS',
    status: 'active' as ActionStatus,
  },
  {
    action_code: 'ARM.MOD13.EXPLAIN_TERMS',
    title_de: 'Fachbegriffe erklären',
    description_de: 'Erklärt Fachbegriffe aus dem Bauträger-Bereich (WEG, Aufteilung, Sondereigentum etc.)',
    zones: ['Z2'] as ArmstrongZone[],
    module: 'MOD-13',
    risk_level: 'low' as RiskLevel,
    execution_mode: 'readonly' as ExecutionMode,
    ...
    api_contract: { type: 'internal' as const, endpoint: null },
    ui_entrypoints: ['/portal/projekte'],
    audit_event_type: 'ARM_MOD13_EXPLAIN_TERMS',
    status: 'active' as ActionStatus,
  },
  {
    action_code: 'ARM.MOD13.VALIDATE_DATA',
    title_de: 'Daten-Plausibilität prüfen',
    description_de: 'Prüft die erfassten Projektdaten auf Plausibilität (Preise, Flächen, Kennzahlen)',
    zones: ['Z2'] as ArmstrongZone[],
    module: 'MOD-13',
    risk_level: 'low' as RiskLevel,
    execution_mode: 'readonly' as ExecutionMode,
    ...
    api_contract: { type: 'edge_function' as const, endpoint: 'sot-armstrong-advisor' },
    ui_entrypoints: ['/portal/projekte'],
    audit_event_type: 'ARM_MOD13_VALIDATE_DATA',
    status: 'active' as ActionStatus,
  },
  {
    action_code: 'ARM.MOD13.CREATE_PROPERTY_FILES',
    title_de: 'Immobilienakten erstellen',
    description_de: 'Konvertiert Projekteinheiten zu eigenständigen Immobilienakten in MOD-04',
    zones: ['Z2'] as ArmstrongZone[],
    module: 'MOD-13',
    risk_level: 'medium' as RiskLevel,
    execution_mode: 'execute_with_confirmation' as ExecutionMode,
    ...
    side_effects: ['creates_properties', 'creates_dms_folders', 'credits_consumed'],
    version: '1.0.0',
    cost_model: 'metered' as CostModel,
    cost_unit: 'per_call' as CostUnit,
    cost_hint_cents: 10,
    api_contract: { type: 'edge_function' as const, endpoint: 'sot-armstrong-advisor' },
    ui_entrypoints: ['/portal/projekte'],
    audit_event_type: 'ARM_MOD13_CREATE_PROPERTY_FILES',
    status: 'active' as ActionStatus,
  },
  {
    action_code: 'ARM.MOD13.START_DISTRIBUTION',
    title_de: 'Vertrieb starten',
    description_de: 'Startet den Vertriebsprozess: Listings erstellen und Partner zuweisen',
    zones: ['Z2'] as ArmstrongZone[],
    module: 'MOD-13',
    risk_level: 'medium' as RiskLevel,
    execution_mode: 'execute_with_confirmation' as ExecutionMode,
    requires_consent_code: null,
    roles_allowed: [],
    data_scopes_read: ['dev_projects', 'dev_project_units', 'properties'],
    data_scopes_write: ['listings', 'partner_assignments'],
    side_effects: ['creates_listings', 'triggers_golden_path', 'credits_consumed'],
    version: '1.0.0',
    cost_model: 'metered' as CostModel,
    cost_unit: 'per_call' as CostUnit,
    cost_hint_cents: 10,
    api_contract: { type: 'edge_function' as const, endpoint: 'sot-armstrong-advisor' },
    ui_entrypoints: ['/portal/projekte'],
    audit_event_type: 'ARM_MOD13_START_DISTRIBUTION',
    status: 'active' as ActionStatus,
  },

  // ===========================================================================
  // MOD-13: PROJEKTE — Lifecycle-Actions (Kategorie B)
  // ===========================================================================
  {
    action_code: 'ARM.MOD13.PHASE_CHANGE',
    title_de: 'Projektphase wechseln',
    description_de: 'Wechselt die Phase eines Projekts (Planung → Genehmigung → Bau → Vertrieb → Übergabe → Abgeschlossen)',
    zones: ['Z2'] as ArmstrongZone[],
    module: 'MOD-13',
    risk_level: 'medium' as RiskLevel,
    execution_mode: 'execute_with_confirmation' as ExecutionMode,
  ...
  {
    action_code: 'ARM.MOD13.PUBLISH_LISTINGS',
    title_de: 'Listings veröffentlichen',
    description_de: 'Veröffentlicht fertige Einheiten als Listings auf dem Marktplatz',
    zones: ['Z2'] as ArmstrongZone[],
    module: 'MOD-13',
    risk_level: 'medium' as RiskLevel,
    execution_mode: 'execute_with_confirmation' as ExecutionMode,
    ...
    api_contract: { type: 'edge_function' as const, endpoint: 'sot-armstrong-advisor' },
    ui_entrypoints: ['/portal/projekte'],
    audit_event_type: 'ARM_MOD13_PUBLISH_LISTINGS',
    status: 'active' as ActionStatus,
  },
  {
    action_code: 'ARM.MOD13.GENERATE_PROJECT_LP',
    title_de: 'Projekt-Landingpage erstellen',
    description_de: 'Generiert eine Vertriebs-Landingpage für ein Bauträgerprojekt',
    zones: ['Z2'] as ArmstrongZone[],
    module: 'MOD-13',
    risk_level: 'medium' as RiskLevel,
    execution_mode: 'execute_with_confirmation' as ExecutionMode,
    requires_consent_code: null,
    roles_allowed: [],
    data_scopes_read: ['dev_projects', 'dev_project_units', 'properties', 'landing_pages'],
    data_scopes_write: ['landing_pages'],
    side_effects: ['creates_landing_page', 'credits_consumed'],
    version: '1.0.0',
    cost_model: 'metered' as CostModel,
    cost_unit: 'per_call' as CostUnit,
    cost_hint_cents: 250,
    api_contract: { type: 'edge_function' as const, endpoint: 'sot-armstrong-advisor' },
    ui_entrypoints: ['/portal/projekte'],
    audit_event_type: 'ARM_MOD13_GENERATE_LP',
    status: 'active' as ActionStatus,
  },
  {
    action_code: 'ARM.MOD13.ANALYZE_INVEST',
    title_de: 'Investment-Analyse starten',
    description_de: 'Startet die Investment-Engine-Berechnung für ein Projekt',
    zones: ['Z2'] as ArmstrongZone[],
    module: 'MOD-13',
    risk_level: 'low' as RiskLevel,
    execution_mode: 'readonly' as ExecutionMode,
    requires_consent_code: null,
    roles_allowed: [],
    data_scopes_read: ['dev_projects', 'dev_project_units', 'investment_engine'],
    data_scopes_write: [],
    side_effects: [],
    version: '1.0.0',
    cost_model: 'free' as CostModel,
    ...
    api_contract: { type: 'internal' as const, endpoint: null },
    ui_entrypoints: ['/portal/projekte'],
    audit_event_type: 'ARM_MOD13_ANALYZE_INVEST',
    status: 'active' as ActionStatus,
  },
  {
    action_code: 'ARM.MOD13.PROJECT_SUMMARY',
    title_de: 'Projekt-Zusammenfassung',
    description_de: 'Erstellt eine kompakte Zusammenfassung des aktuellen Projektstatus',
    zones: ['Z2'] as ArmstrongZone[],
    module: 'MOD-13',
    risk_level: 'low' as RiskLevel,
    execution_mode: 'readonly' as ExecutionMode,
    requires_consent_code: null,
    roles_allowed: [],
    data_scopes_read: ['dev_projects', 'dev_project_units', 'properties', 'listings'],
    data_scopes_write: [],
    side_effects: ['credits_consumed'],
    version: '1.0.0',
    cost_model: 'metered' as CostModel,
    ...
    api_contract: { type: 'edge_function' as const, endpoint: 'sot-armstrong-advisor' },
    ui_entrypoints: ['/portal/projekte'],
    audit_event_type: 'ARM_MOD13_PROJECT_SUMMARY',
    status: 'active' as ActionStatus,
  },

  // ===========================================================================
  // MOD-13: PROJEKTE — Dossier-Hilfe (Kategorie C)
  // ===========================================================================
  {
    action_code: 'ARM.MOD13.EXPLAIN_UNIT',
    title_de: 'Einheit erklären',
    description_de: 'Erklärt die Details einer einzelnen Projekteinheit (Typ, Status, Kennzahlen)',
    zones: ['Z2'] as ArmstrongZone[],
    module: 'MOD-13',
    risk_level: 'low' as RiskLevel,
    execution_mode: 'readonly' as ExecutionMode,
    ...
    api_contract: { type: 'internal' as const, endpoint: null },
    ui_entrypoints: ['/portal/projekte'],
    audit_event_type: 'ARM_MOD13_EXPLAIN_UNIT',
    status: 'active' as ActionStatus,
  },
  {
    action_code: 'ARM.MOD13.UPLOAD_PROJECT_DOC',
    title_de: 'Projektdokument hochladen',
    description_de: 'Unterstützt beim Hochladen und Zuordnen eines Dokuments zum Projekt-Dossier',
    zones: ['Z2'] as ArmstrongZone[],
    module: 'MOD-13',
    risk_level: 'low' as RiskLevel,
    execution_mode: 'execute_with_confirmation' as ExecutionMode,
    requires_consent_code: null,
    roles_allowed: [],
    data_scopes_read: ['dev_projects', 'storage_nodes'],
    data_scopes_write: ['storage_nodes'],
    side_effects: ['uploads_document'],
    version: '1.0.0',
    cost_model: 'free' as CostModel,
    cost_unit: null,
    cost_hint_cents: null,
    api_contract: { type: 'internal' as const, endpoint: null },
    ui_entrypoints: ['/portal/projekte'],
    audit_event_type: 'ARM_MOD13_UPLOAD_DOC',
    status: 'active' as ActionStatus,
  },
  {
    action_code: 'ARM.MOD13.DATA_QUALITY_CHECK',
    title_de: 'Datenqualität prüfen',
    description_de: 'Prüft die Vollständigkeit und Konsistenz aller Projektdaten',
    zones: ['Z2'] as ArmstrongZone[],
    module: 'MOD-13',
    risk_level: 'low' as RiskLevel,
    execution_mode: 'readonly' as ExecutionMode,
    requires_consent_code: null,
    roles_allowed: [],
    data_scopes_read: ['dev_projects', 'dev_project_units', 'properties', 'storage_nodes'],
    data_scopes_write: [],
    side_effects: ['credits_consumed'],
    version: '1.0.0',
    cost_model: 'metered' as CostModel,
    ...
    api_contract: { type: 'edge_function' as const, endpoint: 'sot-armstrong-advisor' },
    ui_entrypoints: ['/portal/projekte'],
    audit_event_type: 'ARM_MOD13_DATA_QUALITY',
    status: 'active' as ActionStatus,
  },
  ...
  // ===========================================================================
  // TIER 2 MAGIC INTAKES
  // ===========================================================================
  {
    action_code: 'ARM.MOD20.MAGIC_INTAKE_CONTRACT',
    title_de: 'Vertrag aus Dokument anlegen',
    description_de: 'Erstellt einen Mietvertrag oder Versorgungsvertrag aus hochgeladenen Dokumenten (Mietvertrag, Nebenkostenabrechnung)',
    zones: ['Z2'],
    module: 'MOD-20',
    risk_level: 'medium',
    execution_mode: 'execute_with_confirmation',
    ...
    cost_hint_cents: 50,
    api_contract: { type: 'edge_function' as const, endpoint: 'sot-armstrong-advisor' },
    ui_entrypoints: ['/portal/miety'],
    audit_event_type: 'ARM_MOD20_MAGIC_INTAKE_CONTRACT',
    status: 'active' as ActionStatus,
  },
  {
    action_code: 'ARM.MOD08.MAGIC_INTAKE_MANDATE',
    title_de: 'Suchmandat aus Dokument anlegen',
    description_de: 'Erstellt ein Suchmandat aus Suchprofil oder Investmentkriterien-PDF',
    zones: ['Z2'],
    module: 'MOD-08',
    risk_level: 'medium',
    execution_mode: 'execute_with_confirmation',
    ...
    api_contract: { type: 'edge_function' as const, endpoint: 'sot-armstrong-advisor' },
    ui_entrypoints: ['/portal/investments'],
    audit_event_type: 'ARM_MOD08_MAGIC_INTAKE_MANDATE',
    status: 'active' as ActionStatus,
  },
  {
    action_code: 'ARM.MOD01.MAGIC_INTAKE_PROFILE',
    title_de: 'Profil aus Dokument anlegen',
    description_de: 'Erstellt Stammdaten aus Visitenkarte, Personalausweis oder Handelsregisterauszug',
    zones: ['Z2'],
    module: 'MOD-01',
    risk_level: 'medium',
    execution_mode: 'execute_with_confirmation',
    ...
    cost_hint_cents: 50,
    api_contract: { type: 'edge_function' as const, endpoint: 'sot-armstrong-advisor' },
    ui_entrypoints: ['/portal/stammdaten'],
    audit_event_type: 'ARM_MOD01_MAGIC_INTAKE_PROFILE',
    status: 'active' as ActionStatus,
  },

  // ===========================================================================
  // TIER 3 MAGIC INTAKES
  // ===========================================================================
  {
    action_code: 'ARM.MOD06.MAGIC_INTAKE_LISTING',
    title_de: 'Verkaufsinserat aus Dokument anlegen',
    description_de: 'Erstellt ein Verkaufsinserat aus einem Exposé oder Eigentumsnachweis',
    zones: ['Z2'],
    module: 'MOD-06',
    risk_level: 'medium',
    execution_mode: 'execute_with_confirmation',
    ...
    api_contract: { type: 'edge_function' as const, endpoint: 'sot-armstrong-advisor' },
    ui_entrypoints: ['/portal/verkauf'],
    audit_event_type: 'ARM_MOD06_MAGIC_INTAKE_LISTING',
    status: 'active' as ActionStatus,
  },
  {
    action_code: 'ARM.MOD09.MAGIC_INTAKE_PARTNER',
    title_de: 'Partner aus Dokument anlegen',
    description_de: 'Erstellt ein Partnerprofil aus Bewerbung, Lebenslauf oder Zertifikaten',
    zones: ['Z2'],
    module: 'MOD-09',
    risk_level: 'medium',
    execution_mode: 'execute_with_confirmation',
    ...
    cost_hint_cents: 50,
    api_contract: { type: 'edge_function' as const, endpoint: 'sot-armstrong-advisor' },
    ui_entrypoints: ['/portal/vertriebspartner'],
    audit_event_type: 'ARM_MOD09_MAGIC_INTAKE_PARTNER',
    status: 'active' as ActionStatus,
  },
  ...
  // ===========================================================================
  {
    action_code: 'ARM.MOD01.EXPLAIN_MODULE',
    title_de: 'Stammdaten erklären',
    description_de: 'Erklärt das Stammdaten-Modul und seine Funktionen',
    zones: ['Z2'] as ArmstrongZone[],
    module: 'MOD-01',
    risk_level: 'low' as RiskLevel,
    execution_mode: 'readonly' as ExecutionMode,
    ...
    version: '1.0.0',
    cost_model: 'free' as CostModel,
    cost_unit: null as CostUnit,
    cost_hint_cents: null,
    api_contract: { type: 'internal' as const, endpoint: null },
    ui_entrypoints: ['/portal/stammdaten'],
    audit_event_type: 'ARM_MOD01_EXPLAIN',
    status: 'active' as ActionStatus,
  },
  {
    action_code: 'ARM.MOD01.CHECK_COMPLETENESS',
    title_de: 'Profil-Vollständigkeit prüfen',
    description_de: 'Prüft die Vollständigkeit des Kontaktprofils und gibt Empfehlungen',
    zones: ['Z2'] as ArmstrongZone[],
    module: 'MOD-01',
    risk_level: 'low' as RiskLevel,
    execution_mode: 'readonly' as ExecutionMode,
    requires_consent_code: null,
    roles_allowed: [],
    data_scopes_read: ['contacts', 'knowledge_base'],
    data_scopes_write: [],
    side_effects: [],
    version: '1.0.0',
    cost_model: 'free' as CostModel,
    ...
    api_contract: { type: 'internal' as const, endpoint: null },
    ui_entrypoints: ['/portal/stammdaten'],
    audit_event_type: 'ARM_MOD01_CHECK_COMPLETENESS',
    status: 'active' as ActionStatus,
  },

  // ===========================================================================
  // MOD-15: FORTBILDUNG ACTIONS
  // ===========================================================================
  {
    action_code: 'ARM.MOD15.EXPLAIN_MODULE',
    title_de: 'Fortbildung erklären',
    description_de: 'Erklärt das Fortbildungs-Modul und verfügbare Kurse',
    zones: ['Z2'] as ArmstrongZone[],
    module: 'MOD-15',
    risk_level: 'low' as RiskLevel,
    execution_mode: 'readonly' as ExecutionMode,
    ...
    cost_hint_cents: null,
    api_contract: { type: 'internal' as const, endpoint: null },
    ui_entrypoints: ['/portal/fortbildung'],
    audit_event_type: 'ARM_MOD15_EXPLAIN',
    status: 'active' as ActionStatus,
  },
  {
    action_code: 'ARM.MOD15.RECOMMEND_COURSE',
    title_de: 'Kurs empfehlen',
    description_de: 'Empfiehlt passende Fortbildungskurse basierend auf Rolle und Erfahrung',
    zones: ['Z2'] as ArmstrongZone[],
    module: 'MOD-15',
    risk_level: 'low' as RiskLevel,
    execution_mode: 'readonly' as ExecutionMode,
    ...
    api_contract: { type: 'internal' as const, endpoint: null },
    ui_entrypoints: ['/portal/fortbildung'],
    audit_event_type: 'ARM_MOD15_RECOMMEND',
    status: 'active' as ActionStatus,
  },
  {
    action_code: 'ARM.MOD15.TRACK_PROGRESS',
    title_de: 'Fortbildungsstand anzeigen',
    description_de: 'Zeigt den aktuellen Fortbildungsstand und empfiehlt nächste Schritte',
    zones: ['Z2'] as ArmstrongZone[],
    module: 'MOD-15',
    risk_level: 'low' as RiskLevel,
    execution_mode: 'readonly' as ExecutionMode,
    ...
    api_contract: { type: 'internal' as const, endpoint: null },
    ui_entrypoints: ['/portal/fortbildung'],
    audit_event_type: 'ARM_MOD15_TRACK',
    status: 'active' as ActionStatus,
  },

  // ===========================================================================
  // MOD-20: MIETY ACTIONS
  // ===========================================================================
  {
    action_code: 'ARM.MOD20.EXPLAIN_MODULE',
    title_de: 'Miety erklären',
    description_de: 'Erklärt das Miety-Modul und seine Funktionen für Mieter',
    zones: ['Z2'] as ArmstrongZone[],
    module: 'MOD-20',
    risk_level: 'low' as RiskLevel,
    execution_mode: 'readonly' as ExecutionMode,
    ...
    api_contract: { type: 'internal' as const, endpoint: null },
    ui_entrypoints: ['/portal/miety'],
    audit_event_type: 'ARM_MOD20_EXPLAIN',
    status: 'active' as ActionStatus,
  },
  {
    action_code: 'ARM.MOD20.EXPLAIN_RIGHTS',
    title_de: 'Mieterrechte erklären',
    description_de: 'Erklärt grundlegende Mieterrechte und Pflichten',
    zones: ['Z2'] as ArmstrongZone[],
    module: 'MOD-20',
    risk_level: 'low' as RiskLevel,
    execution_mode: 'readonly' as ExecutionMode,
    ...
    api_contract: { type: 'internal' as const, endpoint: null },
    ui_entrypoints: ['/portal/miety'],
    audit_event_type: 'ARM_MOD20_RIGHTS',
    status: 'active' as ActionStatus,
  },
  {
    action_code: 'ARM.MOD20.CHECK_NK',
    title_de: 'Nebenkostenabrechnung prüfen',
    description_de: 'Erklärt die Prüflogik einer Nebenkostenabrechnung',
    zones: ['Z2'] as ArmstrongZone[],
    module: 'MOD-20',
    risk_level: 'low' as RiskLevel,
    execution_mode: 'readonly' as ExecutionMode,
    ...
    api_contract: { type: 'internal' as const, endpoint: null },
    ui_entrypoints: ['/portal/miety'],
    audit_event_type: 'ARM_MOD20_CHECK_NK',
    status: 'active' as ActionStatus,
  },

  // ===========================================================================
  // MOD-22: PET MANAGER ACTIONS
  // ===========================================================================
  {
    action_code: 'ARM.MOD22.EXPLAIN_MODULE',
    title_de: 'Pet Manager erklären',
    description_de: 'Erklärt das Pet Manager-Modul und seine Vertriebsfunktionen',
    zones: ['Z2'] as ArmstrongZone[],
    module: 'MOD-22',
    risk_level: 'low' as RiskLevel,
    execution_mode: 'readonly' as ExecutionMode,
    ...
    cost_hint_cents: null,
    api_contract: { type: 'internal' as const, endpoint: null },
    ui_entrypoints: ['/portal/petmanager'],
    audit_event_type: 'ARM_MOD22_EXPLAIN',
    status: 'active' as ActionStatus,
  },
  {
    action_code: 'ARM.MOD22.VIEW_PIPELINE',
    title_de: 'Kunden-Pipeline anzeigen',
    description_de: 'Zeigt eine Übersicht der aktuellen Kunden-Pipeline',
    zones: ['Z2'] as ArmstrongZone[],
    module: 'MOD-22',
    risk_level: 'low' as RiskLevel,
    execution_mode: 'readonly' as ExecutionMode,
    ...
    api_contract: { type: 'internal' as const, endpoint: null },
    ui_entrypoints: ['/portal/petmanager'],
    audit_event_type: 'ARM_MOD22_PIPELINE',
    status: 'active' as ActionStatus,
  },
  {
    action_code: 'ARM.MOD22.DRAFT_CUSTOMER_EMAIL',
    title_de: 'Kunden-E-Mail vorbereiten',
    description_de: 'Erstellt einen E-Mail-Entwurf für einen Kunden (wird nicht automatisch gesendet)',
    zones: ['Z2'] as ArmstrongZone[],
    module: 'MOD-22',
    risk_level: 'low' as RiskLevel,
    execution_mode: 'draft_only' as ExecutionMode,
    ...
    api_contract: { type: 'internal' as const, endpoint: null },
    ui_entrypoints: ['/portal/petmanager'],
    audit_event_type: 'ARM_MOD22_DRAFT_EMAIL',
    status: 'active' as ActionStatus,
  },
];
