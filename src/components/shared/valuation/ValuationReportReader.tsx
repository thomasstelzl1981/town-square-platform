    ...
    <div className={cn('space-y-5', className)}>
      ...
      <Card>
        <CardContent className="p-6 space-y-4">
          <SectionHeader icon={Building2} number={1} title="Objektdaten & Gebäudeangaben" subtitle={'Stammdaten der Immobilie \u2014 fehlende Angaben mit \u201E\u2013\u201C markiert'} />
      ...
      {/* ═══════════════════════════════════════════════════════════════
          GRUNDRISSE, LAGEPLÄNE & UNTERLAGEN (Upload Grid)
          ═══════════════════════════════════════════════════════════════ */}
      {propertyId && tenantId && (
        <Card>
          <CardContent className="p-6 space-y-4">
