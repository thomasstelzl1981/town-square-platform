      ...
      <CardContent className="space-y-2 pt-0">
        ...
        <div className="grid grid-cols-3 gap-2 text-center">
          ...
          <div>
            ...
            <p className="text-base font-bold font-mono leading-tight">{totalEnergyTodayKwh.toFixed(1)}</p>
          ...
          <div>
            ...
            <p className="text-base font-bold font-mono leading-tight">{offlineCount}</p>
