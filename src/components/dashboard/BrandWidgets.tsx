/**
 * BrandWidgets — 3 branded tiles linking to Kaufy, FutureRoom, and System of a Town websites.
 * Reusable across all dashboards (Portal, FM, Akquise).
 */
import { Card, CardContent } from '@/components/ui/card';
import { Button } from '@/components/ui/button';
import { Badge } from '@/components/ui/badge';
import { ExternalLink, ShoppingBag, Landmark, Building2 } from 'lucide-react';
