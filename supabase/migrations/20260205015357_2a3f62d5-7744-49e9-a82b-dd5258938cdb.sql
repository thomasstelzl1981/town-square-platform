-- Fix: document_links.link_status must satisfy document_links_link_status_check (linked/pending/archived)
...
BEGIN
  ...
  -- STEP 9: DOCUMENT LINKS (property scope) - link_status MUST be linked/pending/archived
  ...
  -- Link applicant documents separately
