...
-- Add new legal.deletion.* events to ledger whitelist
...
DECLARE
  ...
  v_allowed_types TEXT[] := ARRAY[
    ...
    'legal.deletion.identity_verified','legal.deletion.identity_failed',
    'legal.deletion.legal_hold_applied','legal.deletion.response_sent',
    'legal.deletion.closed','legal.deletion.rejected'
  ];
...
BEGIN
  ...
  v_allowed_keys := '{
    ...
    "legal.deletion.identity_verified": ["method","deletion_id"],
    "legal.deletion.identity_failed": ["method","deletion_id","reason"],
    "legal.deletion.legal_hold_applied": ["deletion_id","reason"],
    "legal.deletion.response_sent": ["deletion_id","channel","response_type"],
    "legal.deletion.closed": ["deletion_id","resolution"],
    "legal.deletion.rejected": ["deletion_id","reason"]
  }'::jsonb;
