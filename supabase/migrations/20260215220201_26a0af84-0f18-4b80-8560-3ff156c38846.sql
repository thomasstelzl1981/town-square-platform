...
-- View: v_platform_cost_summary
-- Aggregates real platform costs from armstrong_action_runs and armstrong_billing_events
-- for the Zone 1 Platform Cost Monitor

CREATE OR REPLACE VIEW public.v_platform_cost_summary AS
SELECT
  r.action_code,
  COUNT(*) AS total_runs,
