-- ================================================================================
-- D1/D3: Refactored Seed Function (Cleanup-First + Atomic + FK-Safe)
...
BEGIN
  ...
  VALUES ('00000000-0000-4000-a000-000000000005', t_id, 'applicant', 'private', 'Max', 'Mustermann', 'max@mustermann.de', '0170 1234567', '1985-06-15', 'DE', 'married', 'Musterstraße 1', '04109', 'Leipzig', 'employed', 'TechCorp GmbH', 'Leipzig', 4800, 6000, 35000, 15000, 220000, 176000, 44000, 'investment', 85);
