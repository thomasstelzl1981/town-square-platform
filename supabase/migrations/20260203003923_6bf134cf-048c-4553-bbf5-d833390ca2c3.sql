-- Fix seed function with correct column names for leases table
...
BEGIN
  ...
  -- ============ 6. LEASE (corrected column names) ============
  INSERT INTO leases (id, tenant_id, unit_id, tenant_contact_id, start_date, end_date, rent_cold_eur, nk_advance_eur, deposit_amount_eur, payment_due_day, status)
  VALUES 
    ('00000000-0000-4000-a000-000000000120', tenant_id, '00000000-0000-4000-a000-000000000002', '00000000-0000-4000-a000-000000000103', '2022-06-01', NULL, 682, 155, 2046, 3, 'active')
  ON CONFLICT (id) DO UPDATE SET
  ...
  VALUES 
    ('00000000-0000-4000-a000-000000000201', tenant_id, 'SOT-D-000201', 'Exposé_Ankauf_2022.pdf', 'a0000000-0000-4000-a000-000000000001/demo/01/Expose.pdf', 'application/pdf', 150000, 'expose_buy', 'property', 'golden_path_seed'),
    ...
    ('00000000-0000-4000-a000-000000000211', tenant_id, 'SOT-D-000211', 'ESt_Bescheid_2023.pdf', 'a0000000-0000-4000-a000-000000000001/demo/SD/ESt.pdf', 'application/pdf', 160000, 'tax_assessment', 'applicant', 'golden_path_seed'),
    ('00000000-0000-4000-a000-000000000212', tenant_id, 'SOT-D-000212', 'Lohnsteuer_2024.pdf', 'a0000000-0000-4000-a000-000000000001/demo/SD/Lohnst.pdf', 'application/pdf', 75000, 'income_proof', 'applicant', 'golden_path_seed')
  ON CONFLICT (id) DO UPDATE SET
    name = EXCLUDED.name,
