-- Fix: applicant_profiles check constraints in seed_golden_path_data (party_role/purpose/employment_type)
...
BEGIN
  ...
  INSERT INTO document_links (id, tenant_id, document_id, link_status) VALUES
    ('00000000-0000-4000-a000-000000000311'::uuid, t_id, '00000000-0000-4000-a000-000000000211'::uuid, 'linked'),
    ('00000000-0000-4000-a000-000000000312'::uuid, t_id, '00000000-0000-4000-a000-000000000212'::uuid, 'linked');

  -- Applicant profile: satisfy check constraints
  ...
  VALUES (
    '00000000-0000-4000-a000-000000000005'::uuid, t_id,
    'primary',
    'private',
    'Max', 'Mustermann',
