-- Fix seed function: use 'import' as valid source value
...
BEGIN
  ...
  -- ============ 8. DOCUMENTS (12) - using 'import' as valid source ============
  INSERT INTO documents (id, tenant_id, public_id, name, file_path, mime_type, size_bytes, doc_type, scope, source)
  VALUES 
    ('00000000-0000-4000-a000-000000000201', tenant_id, 'SOT-D-000201', 'Exposé_Ankauf.pdf', 'a0000000-0000-4000-a000-000000000001/demo/01/Expose.pdf', 'application/pdf', 150000, 'expose_buy', 'property', 'import'),
    ('00000000-0000-4000-a000-000000000202', tenant_id, 'SOT-D-000202', 'Grundbuchauszug.pdf', 'a0000000-0000-4000-a000-000000000001/demo/03/Grundbuch.pdf', 'application/pdf', 200000, 'land_register', 'property', 'import'),
    ('00000000-0000-4000-a000-000000000203', tenant_id, 'SOT-D-000203', 'Teilungserklaerung.pdf', 'a0000000-0000-4000-a000-000000000001/demo/04/Teilung.pdf', 'application/pdf', 350000, 'division_declaration', 'property', 'import'),
    ('00000000-0000-4000-a000-000000000204', tenant_id, 'SOT-D-000204', 'Grundriss.pdf', 'a0000000-0000-4000-a000-000000000001/demo/05/Grundriss.pdf', 'application/pdf', 80000, 'floorplan', 'property', 'import'),
    ('00000000-0000-4000-a000-000000000205', tenant_id, 'SOT-D-000205', 'Kaufvertrag.pdf', 'a0000000-0000-4000-a000-000000000001/demo/07/Kaufvertrag.pdf', 'application/pdf', 450000, 'purchase_contract', 'property', 'import'),
    ('00000000-0000-4000-a000-000000000206', tenant_id, 'SOT-D-000206', 'Mietvertrag.pdf', 'a0000000-0000-4000-a000-000000000001/demo/08/Mietvertrag.pdf', 'application/pdf', 180000, 'lease_contract', 'property', 'import'),
    ('00000000-0000-4000-a000-000000000207', tenant_id, 'SOT-D-000207', 'WEG_Wirtschaftsplan.pdf', 'a0000000-0000-4000-a000-000000000001/demo/10/WEG.pdf', 'application/pdf', 120000, 'weg_plan', 'property', 'import'),
    ('00000000-0000-4000-a000-000000000208', tenant_id, 'SOT-D-000208', 'Versicherung.pdf', 'a0000000-0000-4000-a000-000000000001/demo/13/Versicherung.pdf', 'application/pdf', 95000, 'insurance', 'property', 'import'),
    ('00000000-0000-4000-a000-000000000209', tenant_id, 'SOT-D-000209', 'Darlehensvertrag.pdf', 'a0000000-0000-4000-a000-000000000001/demo/15/Darlehen.pdf', 'application/pdf', 280000, 'loan_contract', 'property', 'import'),
    ('00000000-0000-4000-a000-000000000210', tenant_id, 'SOT-D-000210', 'Energieausweis.pdf', 'a0000000-0000-4000-a000-000000000001/demo/12/Energie.pdf', 'application/pdf', 110000, 'energy_cert', 'property', 'import'),
    ('00000000-0000-4000-a000-000000000211', tenant_id, 'SOT-D-000211', 'ESt_Bescheid.pdf', 'a0000000-0000-4000-a000-000000000001/demo/SD/ESt.pdf', 'application/pdf', 160000, 'tax_assessment', 'applicant', 'import'),
    ('00000000-0000-4000-a000-000000000212', tenant_id, 'SOT-D-000212', 'Lohnsteuer.pdf', 'a0000000-0000-4000-a000-000000000001/demo/SD/Lohnst.pdf', 'application/pdf', 75000, 'income_proof', 'applicant', 'import')
  ON CONFLICT (id) DO UPDATE SET
    name = EXCLUDED.name,
