-- Create a SECURITY DEFINER function for Golden Path seeding
-- This bypasses RLS for seeding purposes while maintaining security for normal operations
...
BEGIN
  ...
  -- ============ 2. LANDLORD CONTEXT ============
  INSERT INTO landlord_contexts (id, tenant_id, name, context_type, tax_bracket, taxable_income_yearly, marginal_tax_rate, solidarity_surcharge, church_tax, church_tax_rate, children_count, child_allowance, notes)
  VALUES 
  ...
  GET DIAGNOSTICS properties_count = ROW_COUNT;
  ...
  VALUES 
    ('00000000-0000-4000-a000-000000000201', tenant_id, 'SOT-D-000201', 'Exposé_Ankauf_2022.pdf', 'a0000000-0000-4000-a000-000000000001/demo/01_Exposee_Ankauf/Exposé_Ankauf_2022.pdf', 'application/pdf', 150000, 'expose_buy', 'property', 'golden_path_seed'),
    ('00000000-0000-4000-a000-000000000202', tenant_id, 'SOT-D-000202', 'Grundbuchauszug_Leipzig_12345.pdf', 'a0000000-0000-4000-a000-000000000001/demo/03_Grundbuchauszug/Grundbuchauszug.pdf', 'application/pdf', 200000, 'land_register', 'property', 'golden_path_seed'),
    ('00000000-0000-4000-a000-000000000203', tenant_id, 'SOT-D-000203', 'Teilungserklaerung_WEG.pdf', 'a0000000-0000-4000-a000-000000000001/demo/04_Teilungserklaerung/Teilungserklaerung.pdf', 'application/pdf', 350000, 'division_declaration', 'property', 'golden_path_seed'),
    ...
    ('00000000-0000-4000-a000-000000000205', tenant_id, 'SOT-D-000205', 'Kaufvertrag_2022-03-15.pdf', 'a0000000-0000-4000-a000-000000000001/demo/07_Kaufvertrag/Kaufvertrag.pdf', 'application/pdf', 450000, 'purchase_contract', 'property', 'golden_path_seed'),
    ('00000000-0000-4000-a000-000000000206', tenant_id, 'SOT-D-000206', 'Mietvertrag_Bergmann_2022.pdf', 'a0000000-0000-4000-a000-000000000001/demo/08_Mietvertrag/Mietvertrag.pdf', 'application/pdf', 180000, 'lease_contract', 'property', 'golden_path_seed'),
    ('00000000-0000-4000-a000-000000000207', tenant_id, 'SOT-D-000207', 'WEG_Wirtschaftsplan_2024.pdf', 'a0000000-0000-4000-a000-000000000001/demo/10_Wirtschaftsplaene/Wirtschaftsplan.pdf', 'application/pdf', 120000, 'weg_plan', 'property', 'golden_path_seed'),
    ...
    ('00000000-0000-4000-a000-000000000209', tenant_id, 'SOT-D-000209', 'Darlehensvertrag_Sparkasse.pdf', 'a0000000-0000-4000-a000-000000000001/demo/15_Finanzierung/Darlehensvertrag.pdf', 'application/pdf', 280000, 'loan_contract', 'property', 'golden_path_seed'),
    ('00000000-0000-4000-a000-000000000210', tenant_id, 'SOT-D-000210', 'Energieausweis_2022.pdf', 'a0000000-0000-4000-a000-000000000001/demo/12_Energieausweis/Energieausweis.pdf', 'application/pdf', 110000, 'energy_cert', 'property', 'golden_path_seed'),
    ('00000000-0000-4000-a000-000000000211', tenant_id, 'SOT-D-000211', 'Einkommensteuerbescheid_2023.pdf', 'a0000000-0000-4000-a000-000000000001/demo/Stammdaten/ESt_Bescheid.pdf', 'application/pdf', 160000, 'tax_assessment', 'applicant', 'golden_path_seed'),
    ('00000000-0000-4000-a000-000000000212', tenant_id, 'SOT-D-000212', 'Lohnsteuerbescheinigung_Max_2024.pdf', 'a0000000-0000-4000-a000-000000000001/demo/Stammdaten/Lohnsteuer.pdf', 'application/pdf', 75000, 'income_proof', 'applicant', 'golden_path_seed')
  ON CONFLICT (id) DO UPDATE SET
    name = EXCLUDED.name,
